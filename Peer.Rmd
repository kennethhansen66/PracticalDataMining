...
setwd("D:/Documents/Coursera/Practical Machine Learning/")
library(caTools)
library(ROCR)
library(rpart)
library(rpart.plot)
...
```{r echo=TRUE}
rfModel = train(classe ~., data = train, method = "rf", prox = FALSE, trControl = trainControl(method="cv", number = 10),tuneGrid=expand.grid(mtry=c(2,5,10,15,20)))
```
